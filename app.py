...
API_HASH = '637091dfc0eee0e2c551fd832341e18b'  # Reemplaza con tu API_HASH
SESSION_NAME = 'Downloader'

# Funciones de Telegram Downloader (para manejar enlaces t.me)
...
def send_help(message):
    text = (
        ...
        "/downloader <URLs>     - Descargar media t.me"
    )
